...
COLAB_API_URL = "https://1de7b3404166.ngrok-free.app/generate"

# === LLaMA API CALL === https://d5486d26.ngrok-free.app
...
# === Extracted Text ===
resume_text = extract_text_from_pdf(os.path.join(interview_dir, "D:\intership\Phy. Men. Sen. Health Ai\interview bot\interview_doc\Resume (4).pdf"))
job_desc_text = extract_text_from_pdf(os.path.join(interview_dir, "D:\intership\Phy. Men. Sen. Health Ai\interview bot\interview_doc\JD.txt"))
